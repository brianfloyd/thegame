    ...
    return {
        ...
        populateForm(npc) {
            ...
            this.formData = {
                ...
                status_message_idle: npc.status_message_idle || '(idle)',
                status_message_ready: npc.status_message_ready || '(ready)',
                status_message_harvesting: npc.status_message_harvesting || '(harvesting)',
                status_message_cooldown: npc.status_message_cooldown || '(cooldown)'
            };
        ...
        saveNpc() {
            ...
            const npcData = {
                ...
                status_message_idle: this.formData.status_message_idle || '(idle)',
                status_message_ready: this.formData.status_message_ready || '(ready)',
                status_message_harvesting: this.formData.status_message_harvesting || '(harvesting)',
                status_message_cooldown: this.formData.status_message_cooldown || '(cooldown)'
            };
