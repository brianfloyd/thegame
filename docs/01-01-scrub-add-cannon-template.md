...
- Blend gameplay canon into architecture docs (or vice versa)
...
- **Gameplay Canon**
  - Player behavior
  - NPC behavior
  - Rules, mechanics, loops, progression
- **Architecture Canon**
  - System boundaries
  - Services
  - Data flow
...
When finished:
- Write the updated content to `/docs/Chuck docs/`
- File name must start with: `999-`
- Title must clearly indicate **reference or update context**
- These files are **NOT canonical sources of truth**
