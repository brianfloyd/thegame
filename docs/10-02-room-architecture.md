...
- Validates: God mode required `handlers/mapEditor.js:114-118`
- Validates: Required fields present `handlers/mapEditor.js:121-124`
- Validates: Room type in allowed list ['normal', 'merchant', 'bank', 'warehouse'] `handlers/mapEditor.js:128-132`
- Validates: Room type exists in `room_type_colors` table `handlers/mapEditor.js:135-140`
- Validates: No existing room at coordinates `handlers/mapEditor.js:143-147`

**In `updateRoom` handler:**
- Location: `handlers/mapEditor.js:228-298`
- Validates: God mode required `handlers/mapEditor.js:231-235`
- Validates: Required fields present `handlers/mapEditor.js:239-242`
- Validates: Room type in allowed list ['normal', 'merchant', 'bank', 'warehouse', 'factory'] `handlers/mapEditor.js:245-250`
- Validates: Room type exists in `room_type_colors` table `handlers/mapEditor.js:253-258`

**In `deleteRoom` handler:**
- Location: `handlers/mapEditor.js:176-223`
- Validates: Room ID required `handlers/mapEditor.js:181-184`
- Validates: Room exists `handlers/mapEditor.js:187-191`
- Validates: Room not part of outgoing map connection `handlers/mapEditor.js:194-200`
- Validates: No incoming map connections `handlers/mapEditor.js:203-216`

**In movement handler:**
- Location: `handlers/game.js:555-1114`
- Validates: Direction provided and valid `handlers/game.js:702-713`
- Validates: Target room exists `handlers/game.js:767-789`
- Validates: Encumbrance level `handlers/game.js:654-665`
- Validates: Movement cooldown `handlers/game.js:671-678`
...
2. **Validation:** Direction, target room existence, encumbrance `handlers/game.js:702-789`
3. **Database update:** `database.js:792` (updatePlayerRoom)
4. **State cleanup:** Factory widget items dropped to ground `handlers/game.js:808-839`
5. **Poofable items:** Removed from old room `handlers/game.js:842`
6. **Notifications:**
   - `playerLeft` to old room `handlers/game.js:877-882`
   - `moved` to player `handlers/game.js:991-1013`
   - `playerJoined` to new room `handlers/game.js:1064-1069`
   - `roomUpdate` to other players `handlers/game.js:1077`

### Map Connection
1. **Handler:** `handlers/mapEditor.js:322-409` (connectMaps)
2. **Validation:** Source room exists, target room exists, direction available `handlers/mapEditor.js:334-365`
...
3. **Bidirectional cleanup:** Attempts to clear connection on both ends `database.js:104-113`
