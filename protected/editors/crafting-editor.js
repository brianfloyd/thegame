    ...
    return {
        ...
        populateForm(recipe) {
            this.formData = {
                ...
                required_ingredients: this.parseJson(recipe.required_ingredients, []),
                required_runes: this.parseJson(recipe.required_runes, []),
                output_items: this.parseJson(recipe.output_items, []),
                byproducts: this.parseJson(recipe.byproducts, []),
        ...
        addIngredient() {
            this.formData.required_ingredients.push({ item_id: '', quantity: 1 });
        },
        ...
        addOutput() {
            this.formData.output_items.push({ item_id: '', quantity: 1 });
        },
        ...
        addByproduct() {
            this.formData.byproducts.push({ item_id: '', quantity: 1, chance: 0.1 });
        },
